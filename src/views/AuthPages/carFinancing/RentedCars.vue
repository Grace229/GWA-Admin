<template>
    <div>
        ...
        <div v-else class="carcardGrid">
            <RentAndLeaseOrderCards v-for="car in cars" :key="car" :car="car" financeType="Rent" link="/settings/car-financing/auto-loan" />
        </div>
...
import RentAndLeaseOrderCards from './RentAndLeaseOrderCards.vue';
...
const state = reactive({
    params: { buyerId: store.getters['authToken/userId'], orderType: Number(Constants.ordersEnum[3].id), descending: true, pageNumber: 1, pageSize: 9, total: 0 },
});
