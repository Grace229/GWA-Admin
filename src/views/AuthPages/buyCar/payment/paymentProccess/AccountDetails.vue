...
// import {creditCheck} from "@/services/CheckoutServices.js"
...
const rules = {
    ...
    SAFAccountNumber: {
        numeric: helpers.withMessage('The Alternative Bank Account Number must be a number', numeric),
...
const submit = async () => {
    ...
    // state.paymentInfo.customerName = form.SAFAccName;
