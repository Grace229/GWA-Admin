    ...
    <div class="flex gap-5 flex-col md:flex-row md:justify-between md:items-center">
        ...
        <div class="overflow-x-auto">
            <div class="min-w-max flex border border-[#D0D5DD] max-w-max rounded-lg filter">
                <!-- <div @click="selectPeriod(period)" v-for="period in periods" :key="period.id" :class="[period.id !== 4 ? 'border-r border-[#D0D5DD]' : '']" class="cursor-pointer">
                    <div 
...
import DashboardDatePicker from '@/views/AuthPages/vendor/vendorDashboard/DashboardDatePicker.vue';
