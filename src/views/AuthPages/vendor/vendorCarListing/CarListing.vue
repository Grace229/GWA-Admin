<template>
    <div>
        <SettingsPlate header="Listed Cars" description="Manage your vehicle listings">
            <template v-slot:body>
                ...
                <div v-else-if="carList.length === 0 && !loading" class="text-center">
                    ...
                    <!-- ------ -->
                    <button @click="$router.push('/add-car')" class="brandButton flex items-center mx-auto rounded-lg gap-2 mt-5">
                        <div>
                ...
                <div v-else class="">
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between w-full mb-[30px] gap-5">
                        <div class="max-h-max">
                        ...
                        <button @click="$router.push('/add-car')" class="max-w-max brandButton flex items-center rounded-lg gap-2">
                            <div>
                                <svg width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M10.4998 4.16602V15.8327M4.6665 9.99935H16.3332" stroke="white" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round" />
                                </svg>
                    ...
                    <div class="carcardGrid">
                        <CarCard v-for="car in carList" :key="car.id" :car="car" class="rounded-md" />
                    </div>
                    <div v-if="carList.length > 0" class="mt-[40px]"><PaginationComponent /></div>
                </div>
            </template>
        </SettingsPlate>
    </div>
...
import { getCars } from '@/services/VendorServices.js';
