<template>
    <div class="flex flex-col gap-[30px] w-[280px]">
        <div class="flex flex-col pt-[25px] pb-[31px] px-4 bg-[#F9F9FB] border border-[#DCDFEA] rounded-[5px]">
            <div class="flex font-medium text-xs mb-[28px]">
                <button class="bg-[#5D6B98] text-[#FFFFFF] rounded-[3px] py-[5px] px-[8px]">Eligibility Approved</button>
            </div>
