<template>
    <div class="w-full">
        ...
        <div v-if="contractLoading && contractResponse === null" class="w-full flex items-center justify-center py-[100px]"><SpinnerLoader class="h-[80px] w-[80px]" /></div>
        ...
        <div v-else class="flex flex-col gap-[10px]">
            <!-- {{ orderResponse }} -->
            <!-- {{ Constants.contractStatus[orderResponse?.contractStatus] }} -->
            <AltdriveContractDoc />
...
const goToResults = () => {
    ...
    } else if (route.name === 'Rent Payment') {
