<template>
    <div>
        ...
        <div class="mb-5 detailsnfeatures pt-5 pb-[31px]">
            ...
            <div v-if="features" class="flex flex-wrap gap-[15px]">
...
// const pickedOrder = computed(() => orderState.pickedOrder);
