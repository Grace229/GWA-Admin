<template>
    <TransitionRoot class="fixed inset-0 z-[10000] overflow-y-auto" as="template" :show="openEditUser">
                        ...
                        <DialogPanel class="relative transform overflow-hidden rounded-lg bg-white py-[21px] text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-[500px]">
                            ...
                            <div class="overflow-y-auto mt-[20px] flex flex-col gap-3 mb-[10px] px-[20px]">
                                <div class="col-span-2 mb-2">
                                    <h2 class="font-semibold text-[18px] text-[#101828]">Edit Admin</h2>
                                ...
                                <div class="grid grid-cols-2 gap-6">
                                    ...
                                    <div class="col-span-2 grid grid-cols-2 gap-4">
                                        ...
                                        <div class="col-span-2 mb-4">
                                            <!-- {{ form.state }}ss -->
                                            <LabelledSelect class="h-[44px]" :options="stateMenu" v-model="form.state" label="State" :modelValue="form.state" />
                                        </div>
                                        ...
                                        <div class="col-span-2 mt-[14px]">
                                            <button
                                                @click="submit"
                                                :disabled="actionLoading || v$.$invalid"
...
import { editAdmin } from '@/services/AdminServices.js';
// const emits = defineEmits(['proceed']);

const openEditUser = inject('openEditUser');
const actionLoading = ref(false);
const toggleOpenEditUser = inject('toggleOpenEditUser');
const userToEdit = inject('userToEdit');

const selectedCountry = ref(countryList[161]);
// const toggleOpenEditUserText = inject('toggleOpenEditUserText');
const close = () => {
    toggleOpenEditUser();
};
...
const setForms = () => {
    ...
    // const obj = {
    //     id: 'cc814e8d-3f76-49d4-87dd-07fff7bede3c',
    //     firstName: null,
    //     lastName: null,
    //     email: 'biss@gmail.com',
    //     phoneCode: '+234',
    //     phoneNumber: '9049074493',
    //     companyName: null,
    //     country: null,
    //     isPinEnabled: false,
    //     isOwner: false,
    //     tenantId: '00000000-0000-0000-0000-000000000000',
    //     lastLogin: '2023-01-31T22:18:39.394605Z',
    //     photo: null,
    // };
...
const submit = async () => {
    ...
    editAdmin(
        prepareDetails(),
        (res) => {
            Util.handleGlobalAlert(true, 'success', 'Successfully Edited User');
