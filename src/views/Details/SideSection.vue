<template>
    <div class="flex flex-col gap-[30px]">
        <div class="flex flex-col pt-[25px] pb-[31px] px-4 bg-[#F9F9FB] border border-[#DCDFEA] rounded-[5px]">
            <h2 class="font-semibold text-base text-[#30374F] mb-[10px]">Get the 2002 Chevrolet Silverado at a price you’ll love</h2>
            ...
            <h1 class="font-bold text-[24px] text-[#4A5578] mt-5">N4,800,000</h1>
            <span class="mt-[6px] mb-[25px] text-xs font-medium text-[#FF6600]">Starting at N650,000/mo</span>

            <button @click="goToCarPurchase" class="brandButton">Buy this Car</button>
        </div>
            ...
            <div class="bg-[#F9FAFB] rounded-b-[5px]">
                <div class="px-5 pt-[33px]">
                    <div class="col-span-1 mb-5">
                        <label for="cost" class="block text-xs font-medium text-[#344054]">Cost </label>
                        <div class="mt-1">
                            <input
                                type="text"
                                name="cost"
                    ...
                    <div class="col-span-1">
                        ...
                        <div class="mt-1">
                            <input
                                ...
                                autocomplete="off"
                                class="block w-full border-gray-300 focus:border-gray-400 rounded-[4px] shadow-xs focus:outline-none focus:ring-0 sm:text-sm text-gray-900 font-normal"
                                aria-describedby="equityContribution-description"
                            />
                        </div>
                    </div>
                </div>

                <div class="rounded-b-[5px] grid grid-cols-2 pt-5 px-5 pb-[25px] mt-[38px] border-t border-[#EAECF0]">
                    <div class="flex flex-col col-span-1">
                        <h2 class="font-semibold text-base text-[#1D2939]">₦6,408,041</h2>
...
const goToCarPurchase = () => {
    router.push(`/purchase-car/${carId.value}/payment_method`);
};
</script>
