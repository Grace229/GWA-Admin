<template>
    <div class="min-h-full bg-white py-16 px-6 sm:py-24 md:grid md:place-items-center lg:px-8">
        <div class="mx-auto max-w-max">
            <main class="sm:flex">
                <p class="text-4xl font-bold tracking-tight text-[#ff6600] sm:text-5xl">404</p>
                <div class="sm:ml-6">
                    ...
                    <div class="mt-10 flex space-x-3 sm:border-l sm:border-transparent sm:pl-6">
                        <router-link
                            to="/"
                            class="inline-flex items-center rounded-md border border-transparent bg-[#ff6600] px-4 py-2 text-sm font-medium text-white shadow-sm focus:outline-none focus:ring-0"
