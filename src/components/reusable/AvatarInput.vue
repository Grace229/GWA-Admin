<template>
    <div class="h-full w-full">
        ...
        <input :disabled="clickDisabled" type="file" accept="image/*" ref="file" multiple="1" class="hidden" @change="change" />
        <div class="relative inline-block h-full w-full">
            ...
            <div
                @click="browse"
                :class="{ cursorCancel: clickDisabled }"
                class="cursor-pointer absolute top-0 h-full w-full bg-black opacity-25 hover:opacity-50 flex items-center justify-center rounded-full"
            >
                <!-- <button @click="browse"> -->
