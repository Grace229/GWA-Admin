<template>
    <div class="container grid grid-cols-1 md:grid-cols-2 gap-8 pb-[49px]">
        <div class="col-span-1 flex flex-col pt-[35px] px-[40px] pb-[47px] bg-[#F2F4F7] border border-[#red] rounded-[12px]">
            <div class="mb-[24px]">
                <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <rect width="48" height="48" rx="10" fill="url(#paint0_linear_528_38344)" />
                    <path
                    ...
                    />
                    <defs>
                        <linearGradient id="paint0_linear_528_38344" x1="47.9962" y1="24.0013" x2="0.00262607" y2="24.0013" gradientUnits="userSpaceOnUse">
                            <stop offset="0.00114093" stop-color="#F60E0E" />
                            <stop offset="1" stop-color="#FFA800" />
                        </linearGradient>
                    </defs>
                </svg>
            </div>
            <h1 class="mb-[32px] font-semibold text-[30px] text-[#344054]">{{ text.eligibility.title }}</h1>
            <div class="flex items center gap-[14px] mb-5" v-for="item in text.eligibility.items" :key="item">
                <div>
                    <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g clip-path="url(#clip0_695_34123)">
                            <path
                        ...
                        <defs>
                            <linearGradient id="paint0_linear_695_34123" x1="25.6655" y1="14.0008" x2="2.33526" y2="14.0008" gradientUnits="userSpaceOnUse">
                                <stop offset="0.00114093" stop-color="#F60E0E" />
                                <stop offset="1" stop-color="#FFA800" />
                            </linearGradient>
                ...
                <p class="font-normal text-[18px] text-[#475467]">{{ item }}</p>
            </div>
        </div>
        ...
        <div class="col-span-1 flex flex-col pt-[35px] px-[40px] pb-[47px] bg-[#F2F4F7] border border-[#red] rounded-[12px]">
            <div class="mb-[24px]">
                <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <rect width="48" height="48" rx="10" fill="url(#paint0_linear_528_38332)" />
                    <path
                    ...
                    />
                    <defs>
                        <linearGradient id="paint0_linear_528_38332" x1="47.9962" y1="24.0013" x2="0.00262607" y2="24.0013" gradientUnits="userSpaceOnUse">
                            <stop offset="0.00114093" stop-color="#F60E0E" />
                            <stop offset="1" stop-color="#FFA800" />
                        </linearGradient>
                    </defs>
            ...
            <h1 class="mb-[32px] font-semibold text-[30px] text-[#344054]">{{ text.benefits.title }}</h1>
            <div class="flex items center gap-[14px] mb-5" v-for="item in text.benefits.items" :key="item">
                <div>
                    <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g clip-path="url(#clip0_695_34123)">
                            <path
