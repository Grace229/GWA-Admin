<template>
    <div class="cursor-pointer rounded-lg border border-[#D0D5DD] flex items-center gap-[10.5px] py-[10px] px-[18px]">
        <div>
        ...
        <span class="text-[#667085] text-sm font-semibold">Select Dates</span>
    </div>
</template>
