<template>
    ...
    <div>
        ...
        <button @click="sidebarOpen = true" class="fixed bottom-4 right-6 p-4 bg-[#ff6600] text-white rounded-full shadow-lg"><Bars3BottomLeftIcon class="h-6 w-6" aria-hidden="true" /></button>
    </div>
</template>
